			  ...
			  <tr ng-repeat="product in products">
				...
				<td>
					...
					<div class="btn-group" ng-if="type=='Trash'">
						<button type="button" class="btn btn-xs btn-success" ng-click="viewProduct(product.id)" data-toggle="modal" data-target="#restoreModal" ng-click="findId(product.id)"><span class="glyphicon glyphicon-ok-circle"></span> Restore</button>
	...
	<!-- Add Product Modal -->
				...
				<div class="modal-body myCenter">
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<button type="button" class="btn btn-block btn-success" ng-click="deleteProduct()">Yes</button>
						</div>
						<div class="col-md-6 col-sm-6">
		...
		<div class="modal fade" id="finalDeleteModal" role="dialog">
			<div class="modal-dialog modal-sm">
			  <div class="modal-content">
				<div class="modal-header">
				  <h4 class="modal-title">Are you Sure to Delete Permanently ?</h4>
				</div>
				<div class="modal-body myCenter">
					<div class="row">
						<div class="col-md-6 col-sm-6">

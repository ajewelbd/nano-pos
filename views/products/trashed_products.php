				...
				<div class="col-md-8">
					<form class="form-inline" role="form">
						<div class="form-group">
							...
							<a href="products" type="button" class="btn btn-info"><span class="glyphicon glyphicon-list"></span> Show All</a>
						</div>
					</form>
				</div>
				...
				<div class="modal-body myCenter">
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<button type="button" class="btn btn-block btn-success" ng-click="deleteProduct(14)">Yes</button>
						</div>
						<div class="col-md-6 col-sm-6">
